...
/**
 * Maximum two transaction allowed
 */
public class Q3_Buy_and_sell_stocks_III_two_transactions {


    /**
     * Recursive
     */
    public int getMaxProfitRecursive(int[] prices) {
        return getMaxProfitRecursive(prices, 0, 0, 2);
    }
     ...
     * Memoization
     */
    public int getMaxProfitMemoization(int[] prices) {
        int[][][] dp = new int[prices.length][2][2 + 1];

        return getMaxProfitMemoization(prices, 0, 0, 2, dp);
    }
